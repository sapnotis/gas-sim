...
main: main.o model.o walls.o tools.o txt_handler.o
	$(C) build/main.o build/model.o build/walls.o build/tools.o build/txt_handler.o -o main $(OPT) $(CFLAGS) $(SFMLFLAGS)
